...
public class OperacoesAdvogadosExcelLocalRepository : IOperacoesAdvogadosExcelRepository
{
    ...
    public OperacoesAdvogadosExcelLocalRepository(IOptions<ExcelSettings> options, IHostEnvironment environment)
    {
        ...
        var resolvedBasePath = ExcelPathResolver.ResolveBasePath(cfg.BasePath, environment);
        _filePath = Path.Combine(resolvedBasePath, cfg.OperacoesAdvogadosFile);
    }
